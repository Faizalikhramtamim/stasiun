...
<body>
            ...
            <div class="modal-content bg-dark text-light border-secondary">
                ...
                <div class="modal-body" id="print-area">
                    ...
                    <table class="w-100 small text-light">
                        ...
                        <tr><td>Durasi Rencana</td><td>: <strong id="s-estimasi"></strong></td></tr>
    ...
    document.addEventListener('click', function(e) {
        ...
        if (btnStruk) {
            ...
            const masukDate = new Date(waktuMasukStr.replace(/-/g, "/"));
            const sekarang = new Date();
            const selisihMs = sekarang - masukDate;

            // Hitung Hari, Jam, dan Menit Berjalan untuk Struk
            const totalDetik = Math.floor(selisihMs / 1000);
            ...
            let teksDurasiDetail = "";
            if (durasiHari > 0) teksDurasiDetail += `${durasiHari} Hari `;
            if (sisaJam > 0 || durasiHari > 0) teksDurasiDetail += `${sisaJam} Jam `;
            teksDurasiDetail += `${sisaMenit} Menit`;

            const lamaHariBerjalan = Math.ceil(selisihMs / (1000 * 60 * 60 * 24));
            const realHari = lamaHariBerjalan < 1 ? 1 : lamaHariBerjalan;
            ...
            // Menampilkan durasi rencana beserta detail waktu berjalan (Hari, Jam, Menit)
            document.getElementById('s-estimasi').innerText = `${durasiRencana} Hari (Aktif: ${teksDurasiDetail})`;
